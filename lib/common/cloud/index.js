...
class Cloud {
   ...
   * @example
   *
   * this.bsq.cloud.storage.getPublicUrl().then((res) => {
   *     console.log(res.publicUrl);
   * });
   *
   * @name this.bsq.cloud.storage.getPublicUrl
   */
   ...
   * @example
   *
   * this.bsq.cloud.storage.removeFile(remotePath).then(() => {
   *     // file successfully removed
   * });
   *
   * @name this.bsq.cloud.storage.removeFile
   */
}
